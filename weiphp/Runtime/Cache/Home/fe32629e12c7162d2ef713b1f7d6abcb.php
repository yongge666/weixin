...
//添加地址
  var addnewShopUrl = "<?php echo addons_url('Draw://Award/add?model=sport_award');?>";
  function chooseAward(){
  	var $shopHtml = $('<div class="chooseShopDialog"><ul><center><img src="/weixin/weiphp/Public/Home/images/loading.gif"/></center></ul><br/><a href="javascript:;" target="_blank" id="addNewShopBtn" class="border-btn">增加新奖品</a><div class="m15"><a href="javascript:;" class="btn" id="confirmBtn">确定</a></div></div>');
