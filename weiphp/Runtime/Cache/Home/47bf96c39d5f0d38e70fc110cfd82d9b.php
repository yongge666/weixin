...
<div id="main-container" class="container" style="position:relative">
 ...
 <div class="wrap" style="clear:both; margin:30px auto;">
	<section class="tab-content" id="contents">
      ...
      <h3 style=" float:left;margin-bottom:15px;"><img style="vertical-align:middle; height:30px" src="/weixin/weiphp/Public/Home/images/weixin.png"/> 我创建的公众号</h3>
      ...
      <?php if(!empty($list_data[1])): ?><div class="table-striped">
        ...
        <?php else: ?>
        <div style="padding:100px; text-align:center;"><img style="vertical-align:middle;" src="/weixin/weiphp/Public/Home/images/weixin.png"/>  你还没有创建公众号</div><?php endif; ?>
      </div>
      
      <!--
      	<a class="btn" href="<?php echo U('add');?>">+新增公众号</a>
      -->
      <?php if(!empty($list_data[0])): ?><h3 style="margin:15px 0;"><img style="vertical-align:middle; height:25px" src="/weixin/weiphp/Public/Home/images/user_icon.png"/> 我加入的公众号</h3>
      <div class="data-table" style="margin:0">
