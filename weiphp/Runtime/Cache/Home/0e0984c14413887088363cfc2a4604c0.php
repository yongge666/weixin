...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div class="data-table" style="margin-top:20px;">
        ...
        <div class="table-striped">
            ...
            <a class="btn" href="<?php echo U('video_add');?>">新 增</a>
            <?php if(C('MATERIAL')) { ?> 
                <a class="btn" href="<?php echo U('syc_video_to_wechat');?>">一键上传素材到微信素材库</a>
                <a class="btn" href="<?php echo U('syc_file_from_wechat');?>&type=2">一键下载微信素材库到本地</a>
             <?php } ?>
            </div>
                	...
                	<div class="picture_item">
                        <div class="video_item">
                            ...
                            <div class="video_area">
                            	<video src="<?php echo (get_file_url($vo["file_id"])); ?>" controls="controls">您的浏览器不支持 video 标签。</video>
                            </div>
                             <p><?php echo ($vo["desc"]); ?></p>
                        </div>
                        <div class="picture_action">
                            <a href="<?php echo U('video_edit',array('id'=>$vo[id]));?>">编辑</a>
...
function del(id, _this){
	...
	$.post("<?php echo U('video_del');?>",{id:id});
}
</script> 
 <!-- 用于加载js代码 -->
