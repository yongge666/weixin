...
<div id="main-container" class="admin_container">
  ...
  <script type="text/javascript" src="/weixin/weiphp/Public/static/uploadify/jquery.uploadify.min.js?v=<?php echo SITE_VERSION;?>"></script>
  <!-- 标签页导航 -->
                      ...
                      <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
                        ...
                        <?php case "picture": ?><div class="controls uploadrow2">
                            ...
                            <div class="upload-img-box" rel='img'>
                              <?php if(!empty($data[$field['name']])): ?><div class="upload-pre-item"><img src="/weixin/weiphp<?php echo (get_cover($data[$field['name']],'path')); ?>"/></div><?php endif; ?>
                            </div>
                          </div>
                          <script type="text/javascript">
								//上传图片
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/weixin/weiphp/Public/static/uploadify/uploadify.swf",
								...
								function uploadPicture<?php echo ($field["name"]); ?>(file, data){
							        ...
							        if(data.status){
							        	...
							        	src = data.url || '/weixin/weiphp' + data.path;
...
if(weixin_cover_picurl==undefined || weixin_cover_picurl==""){
	$('.weixin-cover-pic').attr('src',"/weixin/weiphp/Public/Home/images/no_cover.png");
}else{
...
<script type="text/javascript" src="/weixin/weiphp/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js?v=<?php echo SITE_VERSION;?>"></script> 
