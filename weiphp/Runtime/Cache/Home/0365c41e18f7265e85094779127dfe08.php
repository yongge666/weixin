...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div class="data-table" style="margin-top:20px;">
        ...
        <a class="btn" href="<?php echo U('voice_add');?>">新 增</a>
        <?php if(C('MATERIAL')) { ?> 
                <a class="btn" href="<?php echo U('syc_voice_to_wechat');?>">一键上传素材到微信素材库</a>
                <a class="btn" href="<?php echo U('syc_file_from_wechat');?>">一键下载微信素材库到本地</a>
         <?php } ?>
        </div>     
                ...
                <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                	<div class="picture_item">
                        <div class="sound_item" onClick="playSound('sound_<?php echo ($vo["id"]); ?>',this);">
                            <img class="icon_sound" src="/weixin/weiphp/Public/Home/images/icon_sound.png"/>
                            <p class="audio_name"><?php echo ($vo["title"]); ?><span class="fr colorless"><?php echo ($vo["file_info"]["playtime"]); ?></span></p>
                        ...
                        <div class="picture_action item_three_action">
                            <a href="<?php echo (get_file_url($vo["file_id"])); ?>">下载</a>
                             <a href="<?php echo U('voice_edit',array('id'=>$vo[id]));?>">编辑</a>
                            <a href="javascript:;" onclick="del(<?php echo ($vo["id"]); ?>, this)">删除</a>	
                        </div>
                    </div>
...
function del(id, _this){
	...
	$.post("<?php echo U('voice_del');?>",{id:id});
}
