...
<section id="contents">
   <div class="setting_step app_setting">
         <a class="step " href="<?php echo U('Home/Public/step_0',array('id'=>$id));?>">1.增加基本信息</a>
         <a class="step step_cur" href="<?php echo U('Home/Public/step_1',array('id'=>$id));?>">2.配置公众平台</a>
         <a class="step step_cur_1" href="<?php echo U('Home/Public/step_2',array('id'=>$id));?>">3.保存接口配置</a>
  </div>  
  <div class="tab-content"> 
    <!-- 表单 -->
    <form class="form-horizontal bind_step_form" method="post" action="<?php echo U('Home/Public/step_2',array('id'=>$id));?>" id="form">
      <!-- 基础文档模型 -->
      <div class="tab-pane in tab1" id="tab1">
        ...
        <div class="form-item cf bind_step_form_next_item">
          <button target-form="form-horizontal" type="submit" id="submit" class="btn submit-btn ajax-post">
          	<?php if($is_audit==0 && !$reg_audit_switch) { echo '提交审核'; } else { echo '保存'; } ?>
