    ...
    <?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p>
        ...
        <?php else: ?>	
            ...
            <?php if(!empty($info["logo"])): ?><img src="<?php echo (get_cover_url($info["logo"])); ?>">
            	<?php else: ?>
            	<img alt="默认LOGO" src="/weixin/weiphp/Public/Home/images/smile.png"><?php endif; ?>
                <div class="info">
...
<script type="text/javascript" src="/weixin/weiphp/Public/static/highcharts-4.0.1/js/highcharts.js"></script>
<script>
$(function () {
    $('.shop_pv').highcharts({
        chart: {
