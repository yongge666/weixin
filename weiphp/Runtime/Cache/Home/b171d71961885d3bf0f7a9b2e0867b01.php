...
<script type="text/javascript" src="/weixin/weiphp/Public/static/qrcode/qrcode.js"></script>
<script type="text/javascript" src="/weixin/weiphp/Public/static/qrcode/jquery.qrcode.js"></script>
<!-- 头部 -->
<div class="login_header">
	
    <div class="log_wrap">
        <a href="/" title="乐摇"><img class="logo" src="/weixin/weiphp/Public/Home/images/logo.png"/></a>
        <!--
        <div class="nav_r">
    	...
    	<div class="top_content">
        	<div class="log_wrap">
            	<div class="top_content_r">
                	<img src="/weixin/weiphp/Public/Home/images/about/img/banner_pic.png?20150723"/>
                </div>
            	<section class="login_box">
                  <form class="login-form" action="/weixin/weiphp/index.php?s=/Home/User/login/from/1.html" method="post">
                          <div class="form_body">
                                <h6>欢迎使用WeiPHP!</h6>
