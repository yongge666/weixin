  ...
  <div class="span9 page_message">
    <section id="contents">
      <ul class="tab-nav nav">
        <li class=""><a href="<?php echo U('lists');?>">刮刮卡列表<b class="arrow fa fa-sort"></b></a></li>
        <li class="current"><a href="javascript:;">新增刮刮卡<b class="arrow fa fa-sort"></b></a></li>
      </ul>
        	...
        	<ul id="tab" class="tab-pane in">
            	 <li class="form-item cf">
                  ...
                  <li class="form-item cf">
                    ...
                    <div class="controls">
                      <label class="textarea input-large">
                      <textarea class="text input-large" name="use_tips" ></textarea>
                      </label>
                    </div>
                  </li>   
                  ...
                  <li class="form-item cf">
                        ...
                        <div class="controls">
                            ...
                            <textarea name="end_tips" style="width:405px; height:100px;"></textarea></label>
                        </div>
                  </li>
                   <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>有效期<span class="check-tips"></span></label>
                    <div class="controls">
                       <input type="datetime" name="start_time" class="text time" value="<?php echo (time_format($data["start_date"])); ?>" placeholder="请选择时间" /> - 
                       <input type="datetime" name="end_time" class="text time" value="<?php echo (time_format($data["end_date"])); ?>" placeholder="请选择时间" />
                    </div>
                  </li>   
                  <li class="form-item cf">
                    ...
                    <div class="controls">
                      <input type="number" class="text input-large" name="predict_num" value="">
                    </div>
                  </li>  
                  <li class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>每人最多允许抽奖次数 <span class="check-tips">（0表示不限制）</span> </label>
                    <div class="controls">
                      <input type="number" class="text input-large" name="max_num" value="">
                    </div>
                  </li>  
...
(function(){
  ...
  <link href="/weixin/weiphp/Public/static/datetimepicker/css/datetimepicker.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
  <?php if(C('COLOR_STYLE')=='blue_color') echo '
    <link href="/weixin/weiphp/Public/static/datetimepicker/css/datetimepicker_blue.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
    '; ?>
  <link href="/weixin/weiphp/Public/static/datetimepicker/css/dropdown.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
  <script type="text/javascript" src="/weixin/weiphp/Public/static/datetimepicker/js/bootstrap-datetimepicker.js"></script> 
  <script type="text/javascript" src="/weixin/weiphp/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=<?php echo SITE_VERSION;?>" charset="UTF-8"></script> 
<script type="text/javascript">
$(function(){
	 initUploadImg();
	 })
